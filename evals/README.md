...
The suite contains five separately licensed real-paper cases plus three CC0 fictional cases. The real cases cover bioinformatics workflows, RNA-seq tool comparison, case-cohort prognosis, and left-truncated survival analysis. The fictional cases include the fully rendered AURORA-12 golden example and the LUMEN-24 observational fixture used on the repository homepage.
